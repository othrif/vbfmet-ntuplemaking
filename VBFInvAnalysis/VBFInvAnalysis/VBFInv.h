...
public:
   ...
   virtual EL::StatusCode   analyzeEvent(Analysis::ContentHolder &content, const ST::SystInfo &systInfo,
   ...
   virtual EL::StatusCode   getMET(std::shared_ptr<xAOD::MissingETContainer> &   met,
...
private:
   ...
   asg::AnaToolHandle<IVGammaORTool>                        m_VyORToolIso;                   //!
