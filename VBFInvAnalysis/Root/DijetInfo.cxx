...
DijetInfo::DijetInfo(std::string prefix, std::string algorithm) : m_prefix(prefix), m_algorithm(algorithm) {}
...
LeadingDijetInfo::LeadingDijetInfo(std::string prefix) : DijetInfo(prefix, "lead") {}
...
MaxDijetInfo::MaxDijetInfo(std::string prefix) : DijetInfo(prefix, "max") {}
...
BestDijetInfo::BestDijetInfo(std::string prefix, std::string algorithm) : DijetInfo(prefix, algorithm) {}
...
MaxAlljetInfo::MaxAlljetInfo(std::string prefix) : DijetInfo(prefix, "maxall") {}
