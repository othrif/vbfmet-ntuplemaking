...
ClassImp(VBFInvSherpaTruth)
   ...
   VBFInvSherpaTruth::VBFInvSherpaTruth()
   : my_XsecDB(0)
{
}
...
EL::StatusCode VBFInvSherpaTruth::initialize()
{
   ...
   m_status20Partons =
      new Analysis::PartonClusterer("status20", this->partonJetPtCut, this->antiktDR, this->shouldNotCluster);
   m_status3Partons =
      new Analysis::PartonClusterer("status3", this->partonJetPtCut, this->antiktDR, this->shouldNotCluster);
   ...
   m_postShower =
      new Analysis::PartonClusterer("postShower", this->partonJetPtCut, this->antiktDR, this->shouldNotCluster);
