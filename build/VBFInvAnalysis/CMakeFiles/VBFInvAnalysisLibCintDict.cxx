...
namespace ROOT {
   ...
   static TGenericClassInfo *GenerateInitInstanceLocal(const ::VBFInv*)
   {
      ...
      static ::ROOT::TGenericClassInfo 
         instance("VBFInv", ::VBFInv::Class_Version(), "VBFInvAnalysis/VBFInv.h", 26,
...
namespace ROOT {
   static void *new_VBFInvTruth(void *p = 0);
   static void *newArray_VBFInvTruth(Long_t size, void *p);
   static void delete_VBFInvTruth(void *p);
   static void deleteArray_VBFInvTruth(void *p);
   static void destruct_VBFInvTruth(void *p);

   // Function generating the singleton type initializer
   static TGenericClassInfo *GenerateInitInstanceLocal(const ::VBFInvTruth*)
   {
      ::VBFInvTruth *ptr = 0;
      static ::TVirtualIsAProxy* isa_proxy = new ::TInstrumentedIsAProxy< ::VBFInvTruth >(0);
      static ::ROOT::TGenericClassInfo 
         instance("VBFInvTruth", ::VBFInvTruth::Class_Version(), "VBFInvAnalysis/VBFInvTruth.h", 22,
                  typeid(::VBFInvTruth), ::ROOT::Internal::DefineBehavior(ptr, ptr),
                  &::VBFInvTruth::Dictionary, isa_proxy, 4,
                  sizeof(::VBFInvTruth) );
      instance.SetNew(&new_VBFInvTruth);
      instance.SetNewArray(&newArray_VBFInvTruth);
      instance.SetDelete(&delete_VBFInvTruth);
      instance.SetDeleteArray(&deleteArray_VBFInvTruth);
      instance.SetDestructor(&destruct_VBFInvTruth);
      return &instance;
   }
   TGenericClassInfo *GenerateInitInstance(const ::VBFInvTruth*)
   {
      return GenerateInitInstanceLocal((::VBFInvTruth*)0);
   }
   // Static variable to force the class initialization
   static ::ROOT::TGenericClassInfo *_R__UNIQUE_DICT_(Init) = GenerateInitInstanceLocal((const ::VBFInvTruth*)0x0); R__UseDummy(_R__UNIQUE_DICT_(Init));
} // end of namespace ROOT
...
//______________________________________________________________________________
atomic_TClass_ptr VBFInvTruth::fgIsA(0);  // static to hold class pointer

//______________________________________________________________________________
const char *VBFInvTruth::Class_Name()
{
   return "VBFInvTruth";
}

//______________________________________________________________________________
const char *VBFInvTruth::ImplFileName()
{
   return ::ROOT::GenerateInitInstanceLocal((const ::VBFInvTruth*)0x0)->GetImplFileName();
}

//______________________________________________________________________________
int VBFInvTruth::ImplFileLine()
{
   return ::ROOT::GenerateInitInstanceLocal((const ::VBFInvTruth*)0x0)->GetImplFileLine();
}

//______________________________________________________________________________
TClass *VBFInvTruth::Dictionary()
{
   fgIsA = ::ROOT::GenerateInitInstanceLocal((const ::VBFInvTruth*)0x0)->GetClass();
   return fgIsA;
}

//______________________________________________________________________________
TClass *VBFInvTruth::Class()
{
   if (!fgIsA.load()) { R__LOCKGUARD(gInterpreterMutex); fgIsA = ::ROOT::GenerateInitInstanceLocal((const ::VBFInvTruth*)0x0)->GetClass(); }
   return fgIsA;
}
...
//______________________________________________________________________________
void VBFInvTruth::Streamer(TBuffer &R__b)
{
   // Stream an object of class VBFInvTruth.

   if (R__b.IsReading()) {
      R__b.ReadClassBuffer(VBFInvTruth::Class(),this);
   } else {
      R__b.WriteClassBuffer(VBFInvTruth::Class(),this);
   }
}

namespace ROOT {
   // Wrappers around operator new
   static void *new_VBFInvTruth(void *p) {
      return  p ? new(p) ::VBFInvTruth : new ::VBFInvTruth;
   }
   static void *newArray_VBFInvTruth(Long_t nElements, void *p) {
      return p ? new(p) ::VBFInvTruth[nElements] : new ::VBFInvTruth[nElements];
   }
   // Wrapper around operator delete
   static void delete_VBFInvTruth(void *p) {
      delete ((::VBFInvTruth*)p);
   }
   static void deleteArray_VBFInvTruth(void *p) {
      delete [] ((::VBFInvTruth*)p);
   }
   static void destruct_VBFInvTruth(void *p) {
      typedef ::VBFInvTruth current_t;
      ((current_t*)p)->~current_t();
   }
} // end of namespace ROOT for class ::VBFInvTruth
...
"VBFInvAnalysis/VBFInvTruth.h",
"VBFInvAnalysis/VBFInv_Defs.h",
"VBFInvAnalysis/contentHolder.h",
"VBFInvAnalysis/outElectron.h",
"VBFInvAnalysis/outEvent.h",
"VBFInvAnalysis/outHolder.h",
"VBFInvAnalysis/outJet.h",
"VBFInvAnalysis/outMET.h",
"VBFInvAnalysis/outMuon.h",
"VBFInvAnalysis/outObject.h",
"VBFInvAnalysis/outTau.h",
0
    };
...
"/cvmfs/atlas.cern.ch/repo/sw/software/21.2/AnalysisBase/21.2.30/InstallArea/x86_64-slc6-gcc62-opt/RootCore/include",
"/cvmfs/atlas.cern.ch/repo/sw/software/21.2/AnalysisBaseExternals/21.2.30/InstallArea/x86_64-slc6-gcc62-opt/include",
"/nfs/dust/atlas/user/othrif/scratch/myNewNtupleMaker/build/VBFInvAnalysis/CMakeFiles/makeVBFInvAnalysisLibCintDict.rT5kO7/",
0
    };
...
class __attribute__((annotate("$clingAutoload$VBFInvAnalysis/VBFInvTruth.h")))  VBFInvTruth;
)DICTFWDDCLS";
